 ...
 */
class RouteOptionalParam008Test extends TestCase
{

	/**
	 * Nette\Application\Route with 'required' optional sequences III.
	 */
	public function testRouteWithRequiredOptionalSequencesIII()
	{
